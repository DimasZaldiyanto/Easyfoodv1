...
import { Ellipse44Icon } from './Ellipse44Icon';
import { Ellipse45Icon } from './Ellipse45Icon';
import { Rectangle89Icon } from './Rectangle89Icon';
import { Rectangle92Icon } from './Rectangle92Icon';
import { Star6Icon } from './Star6Icon';
import { Vector106Icon } from './Vector106Icon';
import { Vector107Icon } from './Vector107Icon';
import { Vector108Icon } from './Vector108Icon';
import { Vector109Icon } from './Vector109Icon';
  ...
  return (
    <div className={`${resets.storybrainResets} ${classes.root}`}>
      ...
      <div className={classes.ellipse43}>
        <Ellipse43Icon className={classes.icon4} />
      </div>
      <div className={classes.ellipse44}>
        <Ellipse44Icon className={classes.icon5} />
      </div>
      <div className={classes.ellipse45}>
        <Ellipse45Icon className={classes.icon6} />
      </div>
      ...
      <div className={classes.vector106}>
        <Vector106Icon className={classes.icon9} />
      </div>
      <div className={classes.vector108}>
        <Vector108Icon className={classes.icon10} />
      </div>
      <div className={classes.vector107}>
        <Vector107Icon className={classes.icon11} />
      </div>
      <div className={classes.vector109}>
        <Vector109Icon className={classes.icon12} />
      </div>
